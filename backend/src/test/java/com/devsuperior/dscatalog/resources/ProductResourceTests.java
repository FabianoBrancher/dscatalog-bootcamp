...
//		QUANDO O MÉTODO É VOID, VOCÊ PRIMEIRO FALA A CONSEQUÊNCIA E DEPOIS FALA QUANDO, 
//		por isso utilizou o doThrow e doNothing
		
		doNothing().when(service).delete(existingId);
		doThrow(ResourceNotFoundException.class).when(service).delete(nonExistingId);
		doThrow(DatabaseException.class).when(service).delete(pendentId);
